...
const AuthorCard = () => {
  return (
    <div>
      <div className="rounded-3xl mt-16 shadow-3xl my-3 bg-white shadow-xl ">
        ...
        <div className="flex justify-center">
          <a href="https://kimlongchann.online/kimlong.jpg">
            <img
              src={kimlong}
              alt=""
              className="rounded-full shadow-xl border-solid border-red-600 border-[3px] -mt-14 w-[150px] h-[150px]"
            />
          </a>
        </div>
        <div className="text-center px-3 pt-2 text-gray-500">
          ...
          <p className="mt-2 font-sans font-light  w-[90%] md:w-[60%] mx-auto block">
        ...
        <div className="flex justify-center pb-8 mt-4 ">
          <div className="flex justify-center space-x-6">
            ...
            <Link
              to="https://instagram.com/kimlonggggggg_101?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"
              className="text-gray-400 hover:"
            >
            ...
            <Link
              to="https://www.tiktok.com/@__c609?is_from_webapp=1&sender_device=pc"
              className="text-gray-400 hover:"
            >
              <div
            ...
            <Link
              to="https://github.com/Kimlong168"
              className="text-gray-400 hover:"
            >
